  ...
  return (
    <div className="max-w-[720px] mx-auto px-6 py-20">
      ...
      <div className="space-y-5 text-[#111111] text-lg leading-relaxed">
        ...
        <p>
          My journey starts at NYU, where I wrote a senior-year thesis in political science. I discovered there what it was like to tackle truly ambiguous problems. <em>Where lifting one stone exposes twelve more, a cool-head and strategic mind helped me choose the best paths.</em>
        </p>
        <p>
